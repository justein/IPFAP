...
public class ViewController extends BaseController {
    ...
    /**专利创造资助与奖励*/
    @RequestMapping(FebsConstant.VIEW_PREFIX+"ipfunds/cninvention")
    public String pageIPFunds() {return FebsUtil.view("ipfunds/cninvention");}
    /**新增专利奖项申报*/
    @RequestMapping(FebsConstant.VIEW_PREFIX+"ipfunds/cninventionAdd")
    public String pageIPFundAdd() {return FebsUtil.view("ipfunds/cninventionAdd");}
